...
# def encoder_fixer(curr):
# 	if(base_case_fixer == 1):
# 		prev = curr
# 		return
# 	else:
# 		if(curr - prev >= 30000):
# 			no_of_loops -= 1
# 			curr = no_of_loops*65535 + curr
# 			prev = curr
# 		if(prev - curr >= 30000):
# 			no_of_loops += 1
# 			curr = no_of_loops*65535 + curr
...
# def callback_kobuki(incoming):
# 	# data['temp_kobuki'] = {incoming.header.seq, incoming.header.stamp.secs, incoming.header.stamp.nsecs}
# 	data['right'] = encoder_fixer(incoming.right_encoder)
# 	data['left'] = encoder_fixer(incoming.left_encoder)
# 	# data['leftTimestamp'] = [incoming.header.stamp.secs, incoming.header.stamp.nsecs]
# 	# data['rightTimestamp'] = [incoming.header.stamp.secs, incoming.header.stamp.nsecs]
